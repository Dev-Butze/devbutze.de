...
module.exports = function (karmaConfig) {
	...
	karmaConfig.set({
		...
		files: [
		  'Sources/JavaScript/Tests/**/*.js',
		  'Sources/JavaScript/Modules/**/*.js'
		],
		...
		preprocessors: {
			'Sources/JavaScript/Modules/**/*.js': ['commonjs', 'coverage'],
			'Sources/JavaScript/Tests/**/*.js': ['commonjs'],
		},
		...
		coverageReporter: {
			reporters: [{
				type: 'text-summary',
				dir: 'Documentation/JavaScript/Coverages/'
			}, {
				type: 'html',
				dir: 'Documentation/JavaScript/Coverages/'
			}]
